        ...
        <div class="container page-padding">
            ...
            <section class="mission-vision-section">
                <div class="info-card">
                    ...
                    <h2>Nossa Missão</h2>
                    <p>Oferecer uma plataforma intuitiva e acessível para a venda de plantas online. Buscamos criar um ambiente digital que valorize a natureza, promovendo bem-estar, sustentabilidade e a conexão entre pessoas e o verde no dia a dia.</p>
                </div>
                <div class="info-card">
                    <i class="fas fa-eye"></i>
                    <h2>Nossa Visão</h2>
                    <p>Transformar o EdenShop em referência no comércio digital de plantas, sendo reconhecido pela experiência de compra simples, pelo design inovador e pela preocupação com a sustentabilidade.</p>
                </div>
            </section>
            ...
            <section class="commitment-section">
                <div class="commitment-text">
                    ...
                    <p>Vivemos em um momento de grandes desafios climáticos. O aquecimento global, a redução da biodiversidade e os eventos extremos são realidades que não podemos ignorar. Na Edenshop, acreditamos que cada planta cultivada é um pequeno passo na direção certa.</p>
                    <p>Nosso compromisso com a <strong>sustentabilidade</strong> vai além das palavras. Buscamos fornecedores locais, utilizamos embalagens recicláveis e promovemos ativamente a conscientização sobre a importância do verde em nossas vidas e cidades. Fazer parte da Edenshop é apoiar um futuro mais verde e saudável.</p>
                </div>
                <div class="commitment-image">
                    <img src="https://img.freepik.com/fotos-premium/uma-pessoa-segurando-uma-planta-na-terra-imagem-generativa-de-ia-plantando-arvores-para-um-futuro-verde-e-sustentavel_87646-11969.jpg" alt="Mãos segurando uma pequena planta com terra">
                </div>
            </section>
        </div>
    </main>
