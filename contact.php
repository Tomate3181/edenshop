...
<body>
    ...
    <main class="container page-padding">
        ...
        <p class="page-subtitle">Tem alguma dúvida, sugestão ou apenas quer dizer um oi? Use o formulário abaixo ou nossos outros canais de atendimento.</p>
        ...
        <div class="contact-layout">
            ...
            <div class="contact-info">
                <h3>Nossos Canais</h3>
                <p><i class="fas fa-envelope"></i> <strong>Email:</strong><br> <a href="mailto:contato@edenshop.com">contato@edenshop.com</a></p>
                <p><i class="fas fa-phone-alt"></i> <strong>Telefone:</strong><br> (11) 99999-8888</p>
                <p><i class="fas fa-map-marker-alt"></i> <strong>Endereço:</strong><br> Av. das Plantas, 123<br>São Paulo, SP - Brasil</p>
